...
export default function PrivateShareSummaryPage() {
        ...
        <Card className="max-w-md w-full border-none shadow-lg">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-500 text-sm">
              This private share link is either incorrect or has been disabled.
            </p>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100">
      {/* Exclusive Header for Shared Project */}
      <header className="bg-white border-b border-gray-100 shadow-sm px-4 sm:px-6">
        <div className="max-w-5xl mx-auto py-6 sm:py-8 flex items-center justify-between">
          ...
          <Badge
            variant="outline"
            className="text-[9px] sm:text-[10px] uppercase font-black gap-1.5 bg-green-50 text-green-700 border-green-200 px-2.5 py-1"
          >
            <Shield size={12} />
            Private Report
          </Badge>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
        ...
        {/* Detailed Analysis Button - Points to private analysis */}
        ...
        {/* Explicit Footer - No navigation out */}
        <div className="text-center pt-16 border-t border-gray-100 mt-16 pb-8">
          <p className="text-xs sm:text-sm text-gray-400 font-bold uppercase tracking-widest">
            Adebanjo Adeniji • QA Research & Analysis
          </p>
          <p className="text-[10px] text-gray-400 mt-2 uppercase tracking-tighter">
            This is an isolated project view. Unauthorized access is prohibited.
          </p>
        </div>
      </main>
    </div>
